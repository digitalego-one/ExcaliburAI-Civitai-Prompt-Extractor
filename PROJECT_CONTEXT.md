...
Firefox compatibility release `2.0.3` uses the AMO-assigned ID `{30c3f901-2664-40d2-87fe-c033983ca00b}`, background scripts, data-collection permissions, and minimum Firefox 142; Chrome continues to use `manifest.json` with the MV3 service worker.
